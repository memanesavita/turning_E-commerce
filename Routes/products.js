...
const { product, products_by_product_id, searchProduct, product_category_id, product_departmentId, productDetails_byId, getLocations_join_ByproductId, products_post_review } = require('../controller/product')
